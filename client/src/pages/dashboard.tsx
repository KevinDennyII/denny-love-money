...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-bold tracking-tight" data-testid="text-page-title">Dashboard</h1>
        <p className="text-muted-foreground text-base">Your family financial overview at a glance</p>
      </div>
